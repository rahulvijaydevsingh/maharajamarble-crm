...
interface TaskManageFiltersDialogProps {
  open: boolean;
...
export function TaskManageFiltersDialog({
  open,
  onOpenChange,
  filters,
  onEdit,
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Edit or delete your saved task filters.
            </DialogDescription>
          </DialogHeader>
                  ...
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        {getFilterCount(filter)} tasks match
                      </div>
                    </div>
                  </div>
