...
const defaultConfigs: Record<string, ColumnConfig[]> = {
  tasks: [
    ...
    { key: "sitePlusCode", label: "Plus Code", visible: false, order: 6, locked: false },
    { key: "dueDate", label: "Due Date", visible: true, order: 7, locked: false },
    { key: "recurrence", label: "Recurrence", visible: true, order: 8, locked: false },
    { key: "status", label: "Status", visible: true, order: 9, locked: false },
    { key: "createdAt", label: "Created", visible: false, order: 10, locked: false },
    { key: "createdBy", label: "Created By", visible: false, order: 11, locked: false },
  ...
  customers: [
    ...
    { key: "assignedTo", label: "Assigned To", visible: true, order: 7, locked: false },
    { key: "tasks", label: "Tasks", visible: true, order: 8, locked: false },
    { key: "totalOrders", label: "Total Orders", visible: false, order: 9, locked: false },
    { key: "totalSpent", label: "Total Spent", visible: false, order: 10, locked: false },
  ...
  professionals: [
    ...
    { key: "sitePlusCode", label: "Plus Code", visible: false, order: 4, locked: false },
    { key: "city", label: "City", visible: true, order: 5, locked: false },
