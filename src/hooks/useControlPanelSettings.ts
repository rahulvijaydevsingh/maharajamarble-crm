    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "13", label: "Website", value: "website", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "14", label: "Referral", value: "referral", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "15", label: "Phone Call", value: "phone_call", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "16", label: "Exhibition", value: "exhibition", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "17", label: "Social Media", value: "social_media", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { id: "des2", label: "Architect", value: "architect", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "des3", label: "Interior Designer", value: "interior_designer", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "des4", label: "Contractor", value: "contractor", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "des5", label: "Builder", value: "builder", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
        ],
      },
      {
        fieldName: "city",
        ...
        allowColors: false,
        options: [
          { id: "lc1", label: "Jaipur", value: "jaipur", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 1 },
          { id: "lc2", label: "Delhi", value: "delhi", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "lc3", label: "Mumbai", value: "mumbai", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "lc4", label: "Bangalore", value: "bangalore", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "lc5", label: "Chennai", value: "chennai", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "lc6", label: "Hyderabad", value: "hyderabad", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
          { id: "lc7", label: "Pune", value: "pune", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 7 },
          { id: "lc8", label: "Ahmedabad", value: "ahmedabad", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 8 },
        ],
      },
    ],
  },
    ...
    fields: [
      {
        ...
        allowColors: true,
        options: [
          { id: "ts1", label: "Pending", value: "Pending", color: "#3B82F6", isActive: true, isDefault: true, isSystemReserved: false, sortOrder: 1 },
          { id: "ts2", label: "In Progress", value: "In Progress", color: "#F59E0B", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "ts3", label: "Completed", value: "Completed", color: "#10B981", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
        ],
      },
      {
        fieldName: "priority",
      ...
      },
      {
        ...
        options: [
          ...
          { id: "tt2", label: "Sample Delivery", value: "Sample Delivery", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "tt3", label: "Site Visit", value: "Site Visit", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "tt4", label: "Quotation Prep", value: "Quotation Prep", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "tt5", label: "Feedback Collection", value: "Feedback Collection", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "tt6", label: "General", value: "General", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
        ],
      },
    ],
  },
