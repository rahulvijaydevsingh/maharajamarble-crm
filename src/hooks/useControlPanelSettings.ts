    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          // KIT Task types
          { id: "tt_kit1", label: "KIT Call", value: "KIT Call", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 10 },
          { id: "tt_kit2", label: "KIT WhatsApp", value: "KIT WhatsApp", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 11 },
          { id: "tt_kit3", label: "KIT Visit", value: "KIT Visit", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 12 },
          { id: "tt_kit4", label: "KIT Email", value: "KIT Email", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 13 },
          { id: "tt_kit5", label: "KIT Meeting", value: "KIT Meeting", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 14 },
        ],
      },
    ],
  },
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "ind9", label: "Finance", value: "finance", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 9 },
          { id: "ind10", label: "Other", value: "other", isActive: true, isDefault: false, isSystemReserved: true, sortOrder: 10 },
        ],
      },
      {
        ...
        allowColors: false,
        options: [
          { id: "csrc1", label: "Direct", value: "direct", isActive: true, isDefault: true, isSystemReserved: false, sortOrder: 1 },
          { id: "csrc2", label: "Referral", value: "referral", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "csrc3", label: "Lead Conversion", value: "lead_conversion", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "csrc4", label: "Website", value: "website", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "csrc5", label: "Social Media", value: "social_media", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "csrc6", label: "Trade Show", value: "trade_show", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
        ],
      },
      {
        fieldName: "city",
        ...
        allowColors: false,
        options: [
          { id: "cc1", label: "Jaipur", value: "jaipur", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 1 },
          { id: "cc2", label: "Delhi", value: "delhi", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "cc3", label: "Mumbai", value: "mumbai", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "cc4", label: "Bangalore", value: "bangalore", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "cc5", label: "Chennai", value: "chennai", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "cc6", label: "Hyderabad", value: "hyderabad", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
          { id: "cc7", label: "Pune", value: "pune", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 7 },
          { id: "cc8", label: "Ahmedabad", value: "ahmedabad", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 8 },
        ],
      },
      {
        fieldName: "priority",
        ...
        allowColors: true,
        options: [
          { id: "cp1", label: "Critical", value: "1", color: "#EF4444", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 1 },
          { id: "cp2", label: "High", value: "2", color: "#F59E0B", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "cp3", label: "Medium", value: "3", color: "#3B82F6", isActive: true, isDefault: true, isSystemReserved: false, sortOrder: 3 },
          { id: "cp4", label: "Low", value: "4", color: "#10B981", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "cp5", label: "Very Low", value: "5", color: "#6B7280", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
        ],
      },
    ],
  },
    ...
    fields: [
      {
        ...
        allowColors: false,
        options: [
          { id: "mat1", label: "Italian Marble", value: "italian_marble", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 1 },
          { id: "mat2", label: "Granite (South)", value: "granite_south", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 2 },
          { id: "mat3", label: "Granite (North)", value: "granite_north", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 3 },
          { id: "mat4", label: "Quartz", value: "quartz", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 4 },
          { id: "mat5", label: "Sandstone", value: "sandstone", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 5 },
          { id: "mat6", label: "Tiles", value: "tiles", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 6 },
          { id: "mat7", label: "Onyx", value: "onyx", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 7 },
          { id: "mat8", label: "Engineered Marble", value: "engineered_marble", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 8 },
          { id: "mat9", label: "Cladding Stone", value: "cladding_stone", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 9 },
          { id: "mat10", label: "Wooden Flooring", value: "wooden_flooring", isActive: true, isDefault: false, isSystemReserved: false, sortOrder: 10 },
        ],
      },
    ],
  },
